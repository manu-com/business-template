      ...
      <Container>
        ...
        >
          ...
          <div className="flex items-center gap-2 lg:hidden">
            ...
            <button
              type="button"
              className="flex h-10 w-10 items-center justify-center rounded-lg text-slate-600 transition-colors duration-200 hover:bg-slate-100 dark:text-gray-400 dark:hover:bg-gray-800"
